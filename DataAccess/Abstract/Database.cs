...
namespace DataAccess.Abstract
{
    ...
    public abstract class Database : IDatabase
    {
        ...
        /// </exception>
        protected Database(string conString)
        {
            _conString = conString;
        }

        protected abstract DbConnection CreateConnection(string conString);
        ...
        public abstract DbParameter CreateOutputParameter(string name, DbType dbType);
        ...
        {
            if (_connection == null)
                _connection = CreateConnection(_conString);
